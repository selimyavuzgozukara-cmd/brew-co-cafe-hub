  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Bir şeyler ters gitti. Lütfen tekrar deneyin.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Brew & Co., küçük partiler hâlinde espresso, filtre kahve ve günlük taze hamur işleri sunan bir mahalle kahvecisidir." },
      { property: "og:title", content: "Brew & Co." },
      { property: "og:description", content: "Küçük parti kahveler, sakin sabahlar." },
...
function ConditionalLayout() {
  ...
  return <PublicChrome><Outlet /></PublicChrome>;
}
