...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Brew & Co. is a neighborhood coffee shop serving small-batch espresso, pour-over, and pastries baked daily." },
      { property: "og:title", content: "Brew & Co." },
      { property: "og:description", content: "Small-batch coffee, slow mornings." },
